...
using DevelopmentTools.Debugging.StateDebugger.IndexedList;
using DevelopmentTools.Debugging.StateDebugger.WrapperHandling;
...
namespace DevelopmentTools.Debugging.StateDebugger {
